...
class Order(models.Model):
    ...
    user = models.ForeignKey(verbose_name=_('User'), to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='orders')
    is_paid = models.BooleanField(default=False)
    status = models.CharField(_('Order Status'), choices=ORDER_STATUSES, max_length=2, default=ORDER_STATUSES[0][0])

    phone_number = models.CharField(_('Phone Number(IR)'), max_length=11, unique=True, null=False,)
